library(stringr)
exercice_text <- "Also did we mention that strings can have any number of characters? Like zero? Zero is indeed an option and, although this might sound confusing now, just know that you can store empty strings."
str_length(exercice_text)

act4s1 <- "SCENE I. Without the Florentine camp.
...
uppercase_issue <- "The Time haS come"
str_to_upper(uppercase_issue)

underscore_issue <- "some_text_from_the_web_that_needs_some_cleaning"
str_replace_all(underscore_issue, "_", " ")

count_items_in_text <- "The stringr package provides an easy to use toolkit for working
...
strings."
str_count(count_items_in_text, "for")
str_count(act4s1, "Lord")
